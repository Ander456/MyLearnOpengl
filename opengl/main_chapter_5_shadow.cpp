...
int main(int argc, const char * argv[]) {
    ...
    Shader shader("path/shadow_mapping.vs", "path/shadow_mapping.fs");
    Shader simpleDepthShader("path/shadow_mapping_depth.vs", "path/shadow_mapping_depth.fs");
    Shader debugDepthQuad("path/debug_quad.vs", "path/debug_quad.fs");
    ...
    // Load textures
    woodTexture = loadTexture("path/wood.png");
